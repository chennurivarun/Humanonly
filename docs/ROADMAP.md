...
- 🔜 Next highest-priority unfinished milestone: validate incremental persistence on managed Postgres infrastructure with production-like latency/pooling and publish evidence.
