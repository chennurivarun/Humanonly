...
- [ ] PostgreSQL migration path (scale-out option from SQLite) — planning artifacts and schema contract added (`docs/SPRINT_4_POSTGRES_MIGRATION_PLAN.md`, `apps/web/db/postgres/schema.sql`)
